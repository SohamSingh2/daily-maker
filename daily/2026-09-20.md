...
Tiny app concept: a clean studio **recipe picker**.
...
<body>
  <main>
    ...
    <p>A clean studio recipe picker with compact mobile layout, random prompt generation, and keyboard shortcuts.</p>
