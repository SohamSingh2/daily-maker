...
<head>
  ...
  <title>Stack Daily Wins Log</title>
  <style>
    body {
      margin: 0;
      min-height: 100vh;
...
<body>
  <main>
    <h1>Stack Daily Wins Log</h1>
    <p>A bright but calm daily wins log with random prompt generation, one-click reset, and daily streak tracking.</p>
