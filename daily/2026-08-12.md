# Sketch Quote Shuffler

Date: 2026-08-12

Tiny app concept: a paper notebook **quote shuffler**.
...
<head>
  ...
  <title>Sketch Quote Shuffler</title>
  <style>
    body {
      margin: 0;
      min-height: 100vh;
...
<body>
  <main>
    <h1>Sketch Quote Shuffler</h1>
    <p>A paper notebook quote shuffler with daily streak tracking, compact mobile layout, and progress rings.</p>
