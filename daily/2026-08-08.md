...
Tiny app concept: a midnight dashboard **micro journal**.
...
<body>
  <main>
    ...
    <p>A midnight dashboard micro journal with compact mobile layout, progress rings, and random prompt generation.</p>
