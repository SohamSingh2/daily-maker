...
Tiny app concept: a paper notebook **recipe picker**.
...
<head>
  ...
  <title>Track Recipe Picker</title>
  <style>
    body {
      margin: 0;
      min-height: 100vh;
...
<body>
  <main>
    <h1>Track Recipe Picker</h1>
    <p>A paper notebook recipe picker with localStorage persistence, daily streak tracking, and random prompt generation.</p>
