...
Tiny app concept: a retro terminal **mood tracker**.
...
<body>
  <main>
    ...
    <p>A retro terminal mood tracker with random prompt generation, keyboard shortcuts, and localStorage persistence.</p>
