...
Tiny app concept: a bright but calm **focus timer**.
...
<body>
  <main>
    <h1>Shape Focus Timer</h1>
    <p>A bright but calm focus timer with one-click reset, daily streak tracking, and random prompt generation.</p>
