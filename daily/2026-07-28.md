...
Tiny app concept: a quiet and crisp **recipe picker**.
...
<head>
  ...
  <title>Capture Recipe Picker</title>
  <style>
    body {
      margin: 0;
      min-height: 100vh;
...
<body>
  <main>
    <h1>Capture Recipe Picker</h1>
    <p>A quiet and crisp recipe picker with export as plain text, keyboard shortcuts, and compact mobile layout.</p>
