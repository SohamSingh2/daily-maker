...
<head>
  ...
  <title>Sketch Recipe Picker</title>
  <style>
    body {
      margin: 0;
      min-height: 100vh;
...
<body>
  <main>
    <h1>Sketch Recipe Picker</h1>
    <p>A warm command center recipe picker with localStorage persistence, one-click reset, and copy-to-clipboard.</p>
