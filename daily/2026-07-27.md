...
Tiny app concept: a retro terminal **micro journal**.
...
<head>
  ...
  <title>Sort Micro Journal</title>
  <style>
    body {
      margin: 0;
      min-height: 100vh;
...
<body>
  <main>
    <h1>Sort Micro Journal</h1>
    <p>A retro terminal micro journal with keyboard shortcuts, export as plain text, and daily streak tracking.</p>
