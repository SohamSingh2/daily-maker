...
<head>
  ...
  <title>Shape Mood Tracker</title>
  <style>
    body {
      margin: 0;
      min-height: 100vh;
...
<body>
  <main>
    <h1>Shape Mood Tracker</h1>
    <p>A paper notebook mood tracker with export as plain text, copy-to-clipboard, and one-click reset.</p>
