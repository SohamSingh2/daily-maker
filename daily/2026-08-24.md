...
<head>
  ...
  <title>Stack Micro Journal</title>
  <style>
    body {
      margin: 0;
      min-height: 100vh;
...
<body>
  <main>
    <h1>Stack Micro Journal</h1>
    <p>A warm command center micro journal with keyboard shortcuts, compact mobile layout, and daily streak tracking.</p>
