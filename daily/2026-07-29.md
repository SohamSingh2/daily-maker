# Nudge Study Sprint Tool

Date: 2026-07-29

Tiny app concept: a retro terminal **study sprint tool**.
...
<head>
  ...
  <title>Nudge Study Sprint Tool</title>
  <style>
    body {
      margin: 0;
      min-height: 100vh;
...
<body>
  <main>
    <h1>Nudge Study Sprint Tool</h1>
    <p>A retro terminal study sprint tool with editable cards, copy-to-clipboard, and export as plain text.</p>
