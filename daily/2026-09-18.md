...
<head>
  ...
  <title>Sketch Habit Spark</title>
  <style>
    body {
      margin: 0;
      min-height: 100vh;
...
<body>
  <main>
    <h1>Sketch Habit Spark</h1>
    <p>A warm command center habit spark with copy-to-clipboard, keyboard shortcuts, and editable cards.</p>
