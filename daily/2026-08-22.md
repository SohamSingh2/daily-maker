...
Tiny app concept: a paper notebook **tiny budget board**.
...
<body>
  <main>
    ...
    <p>A paper notebook tiny budget board with one-click reset, keyboard shortcuts, and random prompt generation.</p>
