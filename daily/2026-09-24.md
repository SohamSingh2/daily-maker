...
<body>
  <main>
    <h1>Nudge Focus Timer</h1>
    <p>A quiet and crisp focus timer with localStorage persistence, copy-to-clipboard, and progress rings.</p>
