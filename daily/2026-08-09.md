...
<head>
  ...
  <title>Stack Recipe Picker</title>
  <style>
    body {
      margin: 0;
      min-height: 100vh;
...
<body>
  <main>
    <h1>Stack Recipe Picker</h1>
    <p>A warm command center recipe picker with keyboard shortcuts, random prompt generation, and copy-to-clipboard.</p>
