...
Tiny app concept: a warm command center **habit spark**.
...
<body>
  <main>
    <h1>Stack Habit Spark</h1>
    <p>A warm command center habit spark with localStorage persistence, export as plain text, and random prompt generation.</p>
