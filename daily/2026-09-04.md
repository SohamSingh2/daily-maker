# Sketch Tiny Budget Board

Date: 2026-09-04

Tiny app concept: a warm command center **tiny budget board**.
...
<head>
  ...
  <title>Sketch Tiny Budget Board</title>
  <style>
    body {
      margin: 0;
      min-height: 100vh;
...
<body>
  <main>
    <h1>Sketch Tiny Budget Board</h1>
    <p>A warm command center tiny budget board with localStorage persistence, keyboard shortcuts, and random prompt generation.</p>
