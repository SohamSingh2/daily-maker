# Shape Study Sprint Tool

Date: 2026-09-19

Tiny app concept: a paper notebook **study sprint tool**.
...
<head>
  ...
  <title>Shape Study Sprint Tool</title>
  <style>
    body {
      margin: 0;
      min-height: 100vh;
...
<body>
  <main>
    <h1>Shape Study Sprint Tool</h1>
    <p>A paper notebook study sprint tool with one-click reset, editable cards, and progress rings.</p>
